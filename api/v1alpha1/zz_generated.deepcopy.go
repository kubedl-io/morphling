...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SamplingCondition) DeepCopyInto(out *SamplingCondition) {
	*out = *in
	in.LastUpdateTime.DeepCopyInto(&out.LastUpdateTime)
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SamplingCondition.
func (in *SamplingCondition) DeepCopy() *SamplingCondition {
	if in == nil {
		return nil
	}
	out := new(SamplingCondition)
	in.DeepCopyInto(out)
	return out
}
...
func (in *SamplingStatus) DeepCopyInto(out *SamplingStatus) {
	*out = *in
	if in.SamplingResults != nil {
		in, out := &in.SamplingResults, &out.SamplingResults
	...
	if in.Conditions != nil {
		in, out := &in.Conditions, &out.Conditions
		*out = make([]SamplingCondition, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
