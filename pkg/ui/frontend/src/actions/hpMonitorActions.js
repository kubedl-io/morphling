...
export const FETCH_HP_JOBS_REQUEST = 'FETCH_HP_JOBS_REQUEST'; //  gets experiments in all namespaces.
...
export const FETCH_HP_JOB_INFO_REQUEST = 'FETCH_HP_JOB_INFO_REQUEST'; //  gets experiment with a specific namespace and name.
...
export const FETCH_HP_JOB_TRIAL_INFO_REQUEST = 'FETCH_HP_JOB_TRIAL_INFO_REQUEST'; // gets trial with a specific namespace and name.
