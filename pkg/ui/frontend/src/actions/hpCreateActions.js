...
export const CHANGE_YAML_HP_SERVICE = 'CHANGE_YAML_HP_SERVICE';

export const changeYamlService = yaml => ({
    type: CHANGE_YAML_HP_SERVICE,
    payload: yaml,
});

export const CHANGE_YAML_HP_CLIENT = 'CHANGE_YAML_HP_CLIENT';

export const changeYamlClient = yaml => ({
    type: CHANGE_YAML_HP_CLIENT,
    payload: yaml,
});
