...
export const SUBMIT_PROFILING_YAML_REQUEST = 'SUBMIT_PROFILING_YAML_REQUEST';
export const SUBMIT_PROFILING_YAML_FAILURE = 'SUBMIT_PROFILING_YAML_FAILURE';
export const SUBMIT_PROFILING_YAML_SUCCESS = 'SUBMIT_PROFILING_YAML_SUCCESS';

export const submitProfilingYaml = (yaml, globalNamespace) => ({
    type: SUBMIT_PROFILING_YAML_REQUEST,
    yaml,
    globalNamespace,
});


export const SUBMIT_TRIAL_YAML_REQUEST = 'SUBMIT_TRIAL_YAML_REQUEST';
export const SUBMIT_TRIAL_YAML_FAILURE = 'SUBMIT_TRIAL_YAML_FAILURE';
export const SUBMIT_TRIAL_YAML_SUCCESS = 'SUBMIT_TRIAL_YAML_SUCCESS';

export const submitPTrialYaml = (yaml, globalNamespace) => ({
    type: SUBMIT_TRIAL_YAML_REQUEST,
    yaml,
    globalNamespace,
});
...
export const FETCH_EXPERIMENT_REQUEST = 'FETCH_EXPERIMENT_REQUEST'; // get brief info of a specific experiment
