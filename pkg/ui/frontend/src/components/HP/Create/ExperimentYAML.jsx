...
const YAML = props => {
    ...
    const submitWholeYaml = () => {
        props.submitProfilingYaml(props.currentYaml, props.globalNamespace);
        props.changeYaml("");
    };
    ...
    return (
        <div>
            <Typography variant={'h5'}>{'Profiling Yaml'}</Typography>
            <hr />
...
export default connect(mapStateToProps, { changeYaml, submitProfilingYaml })(YAML);
