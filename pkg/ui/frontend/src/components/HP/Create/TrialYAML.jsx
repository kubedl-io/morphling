...
import { submitPTrialYaml } from '../../../actions/generalActions';
...
const YAML = props => {
    ...
    const submitWholeYaml = () => {
        props.submitPTrialYaml(props.currentYaml, props.globalNamespace);
        props.changeYaml("");
    };
    ...
    return (
        <div>
            <Typography variant={'h5'}>{'Trial Yaml'}</Typography>
            <hr />
...
export default connect(mapStateToProps, { changeYaml, submitPTrialYaml })(YAML);
