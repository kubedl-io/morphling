                ...
                <Grid container alignItems={'center'} className={classes.grid}>
                    ...
                    <Grid item xs={3}>
                        <FormControl variant="outlined" className={classes.formSelect}>
                            ...
                            <Select
                                value={this.props.mcSpecHP.collector.kind}
                        ...
                        <Grid container alignItems={'center'} className={classes.grid}>
                            ...
                            <Grid item xs={3}>
                                <FormControl variant="outlined" className={classes.formSelect}>
                                    ...
                                    <Select
                                        value={this.props.mcSpecHP.source.fileSystemPath.kind}
                                        onChange={this.onMCFileSystemKindChange}
                                        input={<OutlinedInput labelWidth={120} />}
                                    >
                                        {this.props.jobType === constants.JOB_TYPE_HP &&
                                            this.props.mcSpecHP.collector.kind ===
                                                constants.MC_KIND_FILE && (
                                                <MenuItem
                                                    value={constants.MC_FILE_SYSTEM_KIND_FILE}
                                                    key={0}
                                                >
                                        ...
                                        {this.props.jobType === constants.JOB_TYPE_HP &&
                                            this.props.mcSpecHP.collector.kind ===
                                                ...
                                                <MenuItem
                                                    value={constants.MC_FILE_SYSTEM_KIND_DIRECTORY}
                                                    key={0}
                                                >
                                ...
                                this.props.mcSpecHP.source.fileSystemPath.kind !=
                                    ...
                                    <Grid item xs={3}>
                                        <TextField
                                            ...
                                            value={this.props.mcSpecHP.source.fileSystemPath.path}
                            ...
                            <Grid container alignItems={'center'} className={classes.grid}>
                                ...
                                <Grid item xs={3}>
                                    <TextField
                                        ...
                                        className={classes.textField}
                                        type="number"
                                        value={this.props.mcSpecHP.source.httpGet.port}
                                ...
                                <Grid item xs={3}>
                                    <TextField
                                        label={'HttpGet Path'}
                                        className={classes.textField}
                                        value={this.props.mcSpecHP.source.httpGet.path}
                            ...
                            <Grid container alignItems={'center'} className={classes.grid}>
                                ...
                                <Grid item xs={3}>
                                    <FormControl variant="outlined" className={classes.formSelect}>
                                        ...
                                        <Select
                                            value={this.props.mcSpecHP.source.httpGet.scheme}
                                ...
                                <Grid item xs={3}>
                                    <TextField
                                        label={'Host name'}
                                        className={classes.textField}
                                        value={this.props.mcSpecHP.source.httpGet.host}
                                        ...
                                        <Grid container alignItems={'center'}>
                                            ...
                                            <Grid item xs={3}>
                                                <TextField
                                                    ...
                                                    className={classes.textField}
                                                    value={header.name}
                                                    onChange={this.onMCHttpGetHeaderChange(
                                                        'name',
                                                        index,
                                                    )}
                                                />
                        ...
                        <Grid container alignItems={'center'} className={classes.grid}>
                            <Grid item xs={3}>
                                <Typography variant={'subheading'}>
                                    <Tooltip
                                        title={
                                            'Yaml structure for the custom metrics collector container'
                                        }
                                    >
                                        <HelpOutlineIcon
                                            className={classes.help}
                            ...
                            <Grid item xs={6}>
                                <AceEditor
                                    mode="yaml"
                                    theme="sqlserver"
                                    value={this.props.mcCustomContainerYamlHP}
                                    tabSize={2}
                                    fontSize={13}
                                    width={'100%'}
                ...
                <Grid container alignItems={'center'} className={classes.grid}>
                    <Grid item xs={3}>
                        <Button
                            variant={'contained'}
                            color={'primary'}
                            onClick={this.onMCMetricsFormatAdd}
                        >
                            Add Metrics Format
                        </Button>
                    </Grid>
