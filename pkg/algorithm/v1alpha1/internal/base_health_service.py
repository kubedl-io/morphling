...
from api.v1alpha1.grpc_proto.health.python import health_pb2 as _health_pb2
from api.v1alpha1.grpc_proto.health.python import \
    health_pb2_grpc as _health_pb2_grpc
