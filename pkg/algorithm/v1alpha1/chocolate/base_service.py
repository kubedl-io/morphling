...
from pkg.algorithm.v1alpha1.internal.constant import MAX_GOAL, INTEGER, DOUBLE, CATEGORICAL, DISCRETE
from pkg.algorithm.v1alpha1.internal.trial import Assignment
