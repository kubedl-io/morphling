...
func (m *MockClient) CreateExperiment(arg0 *morphlingv1alpha1.ProfilingExperiment, arg1 ...string) error {
	m.ctrl.T.Helper()
...
func (m *MockClient) DeleteExperiment(arg0 *morphlingv1alpha1.ProfilingExperiment, arg1 ...string) error {
	m.ctrl.T.Helper()
	varargs := []interface{}{arg0}
	for _, a := range arg1 {
		varargs = append(varargs, a)
...
func (m *MockClient) GetExperiment(arg0 string, arg1 ...string) (*morphlingv1alpha1.ProfilingExperiment, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{arg0}
	for _, a := range arg1 {
		varargs = append(varargs, a)
	...
	ret0, _ := ret[0].(*morphlingv1alpha1.ProfilingExperiment)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockClient) GetExperimentList(arg0 ...string) (*morphlingv1alpha1.ProfilingExperimentList, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{}
	for _, a := range arg0 {
		varargs = append(varargs, a)
	...
	ret0, _ := ret[0].(*morphlingv1alpha1.ProfilingExperimentList)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockClient) GetNamespaceList() (*corev1.NamespaceList, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetNamespaceList")
	ret0, _ := ret[0].(*corev1.NamespaceList)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
// GetSampling mocks base method
func (m *MockClient) GetSampling(arg0 string, arg1 ...string) (*morphlingv1alpha1.Sampling, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{arg0}
	for _, a := range arg1 {
		varargs = append(varargs, a)
	}
	ret := m.ctrl.Call(m, "GetSampling", varargs...)
	ret0, _ := ret[0].(*morphlingv1alpha1.Sampling)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetSampling indicates an expected call of GetSampling
func (mr *MockClientMockRecorder) GetSampling(arg0 interface{}, arg1 ...interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]interface{}{arg0}, arg1...)
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetSampling", reflect.TypeOf((*MockClient)(nil).GetSampling), varargs...)
}

// GetTrial mocks base method
func (m *MockClient) GetTrial(arg0 string, arg1 ...string) (*morphlingv1alpha1.Trial, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{arg0}
	for _, a := range arg1 {
		varargs = append(varargs, a)
	...
	ret0, _ := ret[0].(*morphlingv1alpha1.Trial)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockClient) GetTrialList(arg0 string, arg1 ...string) (*morphlingv1alpha1.TrialList, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{arg0}
	for _, a := range arg1 {
		varargs = append(varargs, a)
	...
	ret0, _ := ret[0].(*morphlingv1alpha1.TrialList)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockClient) GetTrialTemplates(arg0 ...string) (*corev1.ConfigMapList, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{}
	for _, a := range arg0 {
		varargs = append(varargs, a)
	...
	ret0, _ := ret[0].(*corev1.ConfigMapList)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockClient) UpdateConfigMap(arg0 *corev1.ConfigMap) error {
	m.ctrl.T.Helper()
...
func (m *MockClient) UpdateExperiment(arg0 *morphlingv1alpha1.ProfilingExperiment, arg1 ...string) error {
	m.ctrl.T.Helper()
	varargs := []interface{}{arg0}
	for _, a := range arg1 {
		varargs = append(varargs, a)
